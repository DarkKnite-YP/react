...
const ExperienceCard = ({ experience, onClick, isActive, isMobile }) => {
  return (
    <div
      onClick={onClick}
      className={`cursor-pointer sm:mb-3 p-5 max-w-xl relative sm:text-left text-center ${
...
const Experience = () => {
  ...
  return (
    <div className="sm:my-2">
      ...
      <div className="relative mt-2 md:mt-2 md:p-20 flex flex-col items-center sm:flex-row sm:items-start">
